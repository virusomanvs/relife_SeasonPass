...
| `isKindOfItem`          | `bool`  | Включить поддержку наследуемости классов у предметов |
...
| `isKindOfEntity`          | `bool`  | Включить поддержку наследуемости классов у мобов|
...
| `zoneNames`      | `string array`   | Зоны моба при попадании в которые будет засчитано убийство. |
