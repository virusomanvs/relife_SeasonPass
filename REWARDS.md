...
| `transportFillSpawn`  | `bool`  | Если включить. То машина или лодка будет заспавнена с бензином внутри и с водой. Не забудьте в аттачменты добавить радиатор если он требуется транспорту.|
