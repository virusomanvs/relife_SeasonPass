...
| `enableMapMarkerForLocationTasks`          | `bool`  |При включении будет добавлять метки на карту с заданиями на посещение мест. Метки будут исчезать при выполнении задания. Поддерживаемые моды **Advanced Groups от LBMaster**|
