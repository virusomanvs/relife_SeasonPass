...
| `countSeasonTasks`          | `int`  | Кол-во сезонных заданий выдаваемое игроку|
| `countDayTasksPremium`          | `int`  | Кол-во ежедневных заданий выдаваемое игроку у которого премиум|
| `countWeekTasksPremium`          | `int`  | Кол-во еженедельных заданий выдаваемое игроку у которого премиум|
| `countSeasonTasksPremium`          | `int`  | Кол-во сезонных заданий выдаваемое игроку у которого премиум|
...
| `seasonDayTasksPremiumID`      | `int array`   | Список ID заданий которые будут рандомно выдаваться игроку у которого есть премиум, ежедневно. Их должно быть больше чем указано в countDayTasksPremium. |
...
| `seasonWeekTasksPremiumID`      | `int array`   | Список ID заданий которые будут рандомно выдаваться игроку у которого есть премиум, еженедельно. Их должно быть больше чем указано в countWeekTasksPremium. |
| `seasonSeasonTasksID`      | `int array`   | Список ID заданий которые будут рандомно выдаваться игроку за сезон. Их должно быть больше чем указано в countSeasonTasks. |
| `seasonSeasonTasksPremiumID`      | `int array`   | Список ID заданий которые будут рандомно выдаваться игроку у которого есть премиум, за сезон. Их должно быть больше чем указано в countSeasonTasksPremium. |
...
| `allowShowInfoBeforeOpen `          | `bool`  | Включает возможность посмотреть награду до ее открытия по уровню |
...
```json
{
    ...
    "seasonDayTasksPremiumID": [
        800,
        801
    ],
    "seasonWeekTasksPremiumID": [
        802,
        803
    ],
    "seasonDayTasksID": [
